...
func main() {
	...
	c := pb.NewEchoClient(conn) // Once the gRPC channel is setup, we nned a client stub to perform RPCs. We get this using the NewEchoClient method provided in the pb package we generated from our .proto
